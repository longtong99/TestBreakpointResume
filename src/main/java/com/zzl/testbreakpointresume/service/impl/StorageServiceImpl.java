package com.zzl.testbreakpointresume.service.impl;
...
import com.zzl.testbreakpointresume.utils.FileMD5Util;
...
public class StorageServiceImpl implements StorageService {
    ...
    /**
     * 采用JDK1.4的NIO的“内存映射文件(memory-mapped files)”来合并文件
     * @param param
     * @throws IOException
     */
    @Override
    ...
    private boolean checkAndSetUploadProgress(MultipartFileParam param, String uploadDirPath) throws IOException {
        ...
        //把上传完成的分块在文件中记录下来，127（其他的数字也可以，自己约定）表示完成，其他表示未完成
